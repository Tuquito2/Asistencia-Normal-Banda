...
st.markdown("""
    ...
    /* Ocultar barra de herramientas y Manage app */
    ...
    /* Ocultar botones flotantes de la nube */
...
if st.session_state.modo == "Login":
    ...
    if lista_alumnos:
        st.write("Listado actual de alumnos:")
        
        # Encabezados de la tabla
        h1, h2, h3, h4, h5 = st.columns([0.5, 2, 2, 2.5, 0.7])
        h1.write("**N°**")
        h2.write("**Apellido**")
        h3.write("**Nombre**")
        h4.write("**Fecha/Hora**")
        ...
        for i, row in enumerate(lista_alumnos, 1):
            ...
            c1, c2, c3, c4, c5 = st.columns([0.5, 2, 2, 2.5, 0.7])
            c1.write(str(i))
            c2.write(ape)
            c3.write(nom)
            c4.write(fec)
