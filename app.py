...
# --- ESCONDER ELEMENTOS DE DESARROLLADOR (OCULTAR ICONOS DE LAS IMÁGENES) ---
st.markdown("""
    <style>
    /* 1. Ocultar el Header completo, GitHub, Deploy y Menú de hamburguesa */
    header {visibility: hidden !important; display: none !important;}
    #MainMenu {visibility: hidden !important;}
    footer {visibility: hidden !important;}
    
    /* 2. Ocultar específicamente el botón 'Manage app' y el Toolbar lateral/superior */
    [data-testid="stToolbar"] {visibility: hidden !important; display: none !important;}
    .stAppDeployButton {display:none !important;}
    
    /* 3. Ocultar el icono de 'barquito' (status widget) y decoraciones de la nube */
    [data-testid="stStatusWidget"] {visibility: hidden !important; display: none !important;}
    #stDecoration {display:none !important;}
    
    /* 4. Ocultar cualquier botón flotante o de gestión en móviles */
    div[data-testid="stStatusWidget"] {display: none !important;}
    button[title="View source on GitHub"] {display: none !important;}
    
    /* 5. Ajuste para eliminar el espacio en blanco superior en móviles y web */
    .stApp {
        margin-top: -50px;
    }
    ...
    /* Bloqueo adicional para selectores de Streamlit Cloud recientes */
